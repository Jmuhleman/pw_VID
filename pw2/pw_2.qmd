...
Le graphe des résidus en haut à gauche nous indique que nous avons une espérance qui se rapporche de 0 puisqe la somme des résidus tends vers 0. La variance des résidus est constante, ce qui est une bonne chose. Le graphe des résidus en fonction des valeurs prédites nous montre que les résidus sont répartis de manière aléatoire autour de 0 car nous n'avons pas de signal cyclique (I.E. sinus...).
